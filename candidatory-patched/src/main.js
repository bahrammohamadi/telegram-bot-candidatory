...
const ANALYSIS_MENU_HANDLER = async (ctx) => {
  const text =
    "🎯 *ارزیابی و تحلیل تخصصی*\n" +
    "━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n" +
    "در این بخش می‌توانید وضعیت آمادگی و جایگاه رقابتی خود را با ابزارهای علمی بسنجید:\n\n" +
    "1️⃣ *ارزیابی آمادگی (۹ مرحله)* — سنجش ابعاد پنج‌گانه‌ی کاندیداتوری و دریافت توصیه‌های عملیاتی (رایگان).\n" +
    "2️⃣ *تحلیل SWOT* — بررسی عمیق نقاط قوت، ضعف، فرصت‌ها و تهدیدها (نیاز به بسته راه‌اندازی).\n\n" +
    "_نوع ارزیابی مورد نظر را انتخاب کنید:_";
...
const CAMPAIGN_MENU_HANDLER = async (ctx) => {
  const text =
    ...
    "━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n" +
    "این ستاد مجازی، ابزارهای عملیاتی لازم جهت سازماندهی و هدایت کمپین را در اختیارتان می‌گذارد:\n\n" +
    "• 👤 *پروفایل کاندیدا* — ثبت و ویرایش مشخصات فردی، سوابق و اولویت‌ها.\n" +
    "• 🧭 *تحلیل SWOT* — طراحی استراتژی رقابتی بر اساس ماتریس ۴ بُعدی.\n" +
    "• ⚔️ *رقبا* — ثبت سیستماتیک، تحلیل نقاط قوت/ضعف و مقایسه‌ی رقبا.\n" +
    "• 📋 *وعده‌ها* — مدیریت وعده‌های انتخاباتی، دسته‌بندی و رصد اجرای آن‌ها.\n" +
    "• 🚨 *مدیریت بحران* — ثبت شایعات/حملات و دریافت استراتژی مکتوبِ واکنش سریع.\n" +
    "• ✍️ *تولید محتوا* — نگارش هوشمند پست، بیانیه، سخنرانی، پیامک و شعار با AI.\n\n" +
    "_بخش مورد نظر را انتخاب کنید:_";
