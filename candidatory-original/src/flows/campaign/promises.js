...
async function handlePromisesMenu(ctx) {
  ...
  let t = "📋 *سازماندهی و مدیریت وعده‌های انتخاباتی*\n━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n";
  t += "در این بخش می‌توانید وعده‌ها و برنامه‌های کمپین خود را ثبت، دسته‌بندی و اولویت‌بندی کنید. *ثبت وعده‌های شفاف، زمان‌دار و قابل اجرا (SMART) اصلی‌ترین عامل جلب اعتماد رأی‌دهندگان است.*\n\n";
  if (promises.length === 0) {
    t += "✅ *هنوز هیچ وعده‌ای ثبت نشده است.*\n\n";
    t += "📌 برای ثبت اولین وعده‌ی انتخاباتی، روی دکمه‌ی «ثبت وعده جدید» کلیک کنید.";
  } else {
