...
async function handleContentMenu(ctx) {
  ...
  const text =
    "✍️ *تولید محتوای هوشمند انتخاباتی (AI)*\n" +
    "━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n" +
    "در این بخش، هوش مصنوعی با مطالعه‌ی مشخصات، سوابق و برنامه‌های شما در «پروفایل کاندیدا»، *محتوای حرفه‌ای، استاندارد و متمایز* جهت انتشار در رسانه‌ها تولید می‌کند.\n\n" +
    "_موارد دارای 🔒 با ارتقای بسته فعال می‌شوند._\n\n" +
    "👈 نوع محتوای مورد نظر را جهت تولید انتخاب کنید:";
