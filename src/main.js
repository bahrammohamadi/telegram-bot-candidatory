...
bot.command("start", async (ctx) => {
  await ctx.reply(
    ...
    "━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n" +
    "🏆 *اولین دستیار هوشمند کمپین انتخاباتی در ایران*\n\n" +
    "✨ *امکانات:*\n" +
...
bot.command("menu", async (ctx) => {
  await ctx.reply("🏠 *منوی اصلی:*", { parse_mode: "Markdown", reply_markup: mainMenuKB() });
});
...
bot.callbackQuery("menu", async (ctx) => {
  try {
    await ctx.editMessageText("🏠 *منوی اصلی:*", { parse_mode: "Markdown", reply_markup: mainMenuKB() });
  } catch {
    await ctx.reply("🏠 *منوی اصلی:*", { parse_mode: "Markdown", reply_markup: mainMenuKB() });
  }
