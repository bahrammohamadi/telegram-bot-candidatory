...
async function showSummary(ctx, userId, answers) {
  ...
  t += "\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n";
  t += "💡 *راهنمای مرحله نهایی:*\n";
  t += "• جهت ویرایش یا اصلاح هر پاسخ، کافیست روی دکمه‌ی مربوط به آن در کیبورد زیر کلیک کنید.\n";
  t += "• اگر تمام اطلاعات مورد تأیید است، جهت محاسبه‌ی علمی امتیاز و دریافت *گزارش و توصیه‌های عملیاتی اختصاصی*، دکمه‌ی «✅ تایید نهایی و دریافت گزارش» را بزنید.";
