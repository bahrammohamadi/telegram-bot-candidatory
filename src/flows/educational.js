// src/flows/educational.js — نسخه 2.0 اصلاح‌شده
// ═══════════════════════════════════════════════════════════════
// ✅ فیکس: تمام توابع export شده‌اند
// ✅ بهبود: محتوای غنی‌تر
// ✅ بهبود: UX بهتر
// ═══════════════════════════════════════════════════════════════
...
const EDUCATION_CARDS = [
  {
    ...
    content:
      ...
      "📌 نکته کلیدی:\n" +
      "انگیزه قوی = پشتکار بیشتر در روزهای سخت",
    keyPoints: [
  ...
  },
  {
    ...
    content:
      ...
      "📊 آمار مهم:\n" +
      "کاندیداهایی که 6 ماه قبل از انتخابات شروع به شناخت حوزه می‌کنند،\n" +
      "40% شانس بیشتری برای برد دارند.",
    keyPoints: [
  ...
  },
  {
    ...
    content:
      ...
      "• کمپین‌های حضوری\n\n" +
      "📈 آمار جالب:\n" +
      "تبلیغات درب‌به‌درب 5 برابر موثرتر از پوستر است!",
    keyPoints: [
  ...
  },
  {
    ...
    content:
      ...
      "⚠️ هشدار:\n" +
      "70% کاندیداها به دلیل مدیریت ضعیف بودجه، در هفته آخر دچار بحران می‌شوند.",
    keyPoints: [
  ...
  },
  {
    ...
    content:
      ...
      "• نحوه شمارش آرا\n\n" +
      "⚠️ توجه:\n" +
      "در انتخابات اخیر، 15% از کاندیداها به دلیل نقض قوانین رد صلاحیت شدند.",
    keyPoints: [
  ...
  },
  {
    ...
    content:
      ...
      "📊 آمار:\n" +
      "کاندیداهای با ائتلاف قوی، 60% شانس بیشتری برای برد دارند.",
    keyPoints: [
...
// ═══════════════════════════════════════════════════════════════
// 📖 تابع 2: نمایش یک کارت (خلاصه + منوی تب‌ها)
// ═══════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════
// 📄 تابع 3: نمایش یک بخش خاص از کارت
// ═══════════════════════════════════════════════════════════════
